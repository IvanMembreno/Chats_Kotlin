...
//    PROGRESS DIALOG
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken(getString(R.string.default_web_client_in))
            .requestEmail()
            .build()
...
//        enableEdgeToEdge()
    ...
    private fun iniciarGoogle() {
        ...
        googleSignActivityResultLauncher.launch(googleSignIntent)
    }

    private val googleSignActivityResultLauncher = registerForActivityResult(
